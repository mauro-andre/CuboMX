type MxProxy = Record<string, any> & {
    $watch?: <K extends string>(property: K, callback: (this: MxProxy, newValue: any, oldValue: any) => void) => void;
...
declare class MxComponent {
    $el: HTMLElement;
    $watch: <K extends keyof this>(prop: K, callback: (this: this, newValue: this[K], oldValue: this[K]) => void) => void;
    init?(): void;
    destroy?(): void;
}
export { MxProxy, MxElProxy, MxComponent, PublicAPI, MxElement, Reaction, RequestResponse, ArrayItems, ClassList };
