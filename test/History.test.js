...
describe("CuboMX History Integration", () => {
    ...
    it("should push a new URL and title to history and restore content on popstate", async () => {
        ...
        CuboMX.swap(`<div id="content">Content Page 2</div>`, [{ target: "#content:outerHTML" }], { pushUrl: "/page-2", title: "Page 2 Title" });
        await new Promise((resolve) => setTimeout(resolve, 0)); // Espera o DOM estabilizar
        expect(document.querySelector("#content")?.textContent).toBe("Content Page 2");
        ...
        CuboMX.swap(`<div id="content">Content Page 3</div>`, [{ target: "#content:outerHTML" }], { pushUrl: "/page-3", title: "Page 3 Title" });
        await new Promise((resolve) => setTimeout(resolve, 0)); // Espera o DOM estabilizar
        ...
        simulatePopstate({
            swaps: [
                { selector: "#content", htmls: [initialContent] },
            ],
            title: initialTitle,
        });
        await new Promise((resolve) => setTimeout(resolve, 0));
        expect(document.querySelector("#content")?.outerHTML).toBe(initialContent);
    ...
    it("should handle multiple swaps and restore correctly on popstate", async () => {
        ...
        await new Promise((resolve) => setTimeout(resolve, 0)); // Espera o DOM estabilizar
        expect(document.querySelector("#header")?.textContent).toBe("New Header Page 2");
        expect(document.querySelector("#content")?.textContent).toBe("New Content Page 2");
        expect(document.querySelector("#footer")?.textContent).toBe("New Footer Page 2");
        ...
        CuboMX.swap(`<div id="content">Temp Page</div>`, [{ target: "#content:outerHTML" }], { pushUrl: "/temp", title: "Temp" });
        await new Promise((resolve) => setTimeout(resolve, 0)); // Espera o DOM estabilizar
        ...
        simulatePopstate({
            swaps: [
                { selector: "#header", htmls: [initialHeader] },
                { selector: "#content", htmls: [initialContent] },
                { selector: "#footer", htmls: [initialFooter] },
            ],
            title: initialDocumentTitle,
        });
        await new Promise((resolve) => setTimeout(resolve, 0)); // Espera o DOM estabilizar
        expect(document.querySelector("#header")?.outerHTML).toBe(initialHeader);
        expect(document.querySelector("#content")?.outerHTML).toBe(initialContent);
        expect(document.querySelector("#footer")?.outerHTML).toBe(initialFooter);
    ...
    it("should not affect history if pushUrl is not provided", async () => {
        ...
        await new Promise((resolve) => setTimeout(resolve, 0)); // Espera o DOM estabilizar
        expect(document.querySelector("#content")?.textContent).toBe("Content without history");
        ...
        await new Promise((resolve) => setTimeout(resolve, 0)); // Espera o DOM estabilizar
        expect(document.querySelector("#content")?.textContent).toBe("Content without history"); // Content remains
    });
    it("should restore title correctly even if content is not swapped", async () => {
        const initialTitle = document.title;
        const initialContent = document.querySelector("#content")?.outerHTML;
        CuboMX.swap(`<div id="non-existent">New Content</div>`, // Swap to a non-existent element
        [{ target: "#non-existent:outerHTML" }], { pushUrl: "/only-title", title: "Only Title Page" });
        await new Promise((resolve) => setTimeout(resolve, 0)); // Espera o DOM estabilizar
        expect(window.location.pathname).toBe("/only-title");
        expect(document.title).toBe("Only Title Page");
        expect(document.querySelector("#content")?.outerHTML).toBe(initialContent); // Content should be unchanged
        ...
        await new Promise((resolve) => setTimeout(resolve, 0)); // Espera o DOM estabilizar
        expect(document.title).toBe("Only Title Page");
        expect(document.querySelector("#content")?.outerHTML).toBe(initialContent); // Content should still be unchanged
        window.history.back(); // Back to initial page
        await new Promise((resolve) => setTimeout(resolve, 10));
        simulatePopstate({
            swaps: [
    ...
    it("should handle forward navigation correctly", async () => {
        ...
        const initialTitle = document.title;
        // Page 1 -> Page 2
        CuboMX.swap(`<div id="content">Page 2 Content</div>`, [{ target: "#content:outerHTML" }], { pushUrl: "/page-2", title: "Page 2" });
        await new Promise((resolve) => setTimeout(resolve, 0)); // Espera o DOM estabilizar
        const page2State = window.history.state;
        // Page 2 -> Page 3
        CuboMX.swap(`<div id="content">Page 3 Content</div>`, [{ target: "#content:outerHTML" }], { pushUrl: "/page-3", title: "Page 3" });
        await new Promise((resolve) => setTimeout(resolve, 0)); // Espera o DOM estabilizar
        expect(window.location.pathname).toBe("/page-3");
        ...
        expect(document.querySelector("#content")?.textContent).toBe("Page 2 Content");
        // Back to Page 1
        window.history.back();
        await new Promise((resolve) => setTimeout(resolve, 10));
        simulatePopstate({
