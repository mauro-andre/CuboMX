...
describe("CuboMX Refactor - DOM Mutation Lifecycle", () => {
    ...
    it("should bind directives on new elements that are not components themselves", async () => {
        ...
        // 2. Dynamically add a new chunk of HTML using mx-bind.
        const newContent = document.createElement("div");
        newContent.innerHTML = `
            <span mx-bind="$testStore.spanAttrs">Hello</span>
    ...
    it("should re-evaluate directives when child content is replaced", async () => {
        ...
        parentDiv.innerHTML = `<div id="child" mx-bind:my-prop="$myComp.myVar" my-prop="value1"></div>`;
        ...
        parentDiv.innerHTML = `<div id="child" mx-bind:my-prop="$myComp.myVar" my-prop="value2"></div>`;
        await vi.runAllTimersAsync();
