...
describe("CuboMX.request()", () => {
    ...
    it("should make a GET request with default settings", async () => {
        ...
        expect(fetchMock).toHaveBeenCalledWith("https://example.com/api/users", expect.objectContaining({
            method: "GET",
            credentials: "include",
        }));
    ...
    it("should convert body to query string for GET requests", async () => {
        ...
        expect(fetchMock).toHaveBeenCalledWith("https://example.com/api/users?page=2&limit=10", expect.any(Object));
    });
    it("should append query string to existing query params", async () => {
        ...
        expect(fetchMock).toHaveBeenCalledWith("https://example.com/api/users?existing=true&page=2", expect.any(Object));
    });
    ...
    it("should send PUT requests correctly", async () => {
        ...
        expect(fetchMock).toHaveBeenCalledWith("https://example.com/api/users/1", expect.objectContaining({
            method: "PUT",
    ...
    it("should allow custom Content-Type to override default for JSON", async () => {
        ...
        expect(fetchMock).toHaveBeenCalledWith("https://example.com/api/custom", expect.objectContaining({
            headers: expect.objectContaining({
                "Content-Type": "application/x-www-form-urlencoded",
            }),
        }));
