...
describe("CuboMX.swap - Basic operations", () => {
    ...
    it("should swap different source to different target", () => {
        ...
        expect(document.querySelector("#new-content")?.textContent).toBe("Fresh content");
    });
});
describe("CuboMX.swap - innerHTML vs outerHTML", () => {
    ...
    it("should swap outerHTML (replace entire element)", () => {
        ...
        expect(document.querySelector("#new-container")?.textContent).toBe("New content");
        expect(document.querySelector("#new-container")?.className).toBe("card");
    });
...
describe("CuboMX.swap - Multiple operations", () => {
    ...
    it("should perform multiple swaps in sequence", () => {
        ...
        expect(document.querySelector("#new-header")?.textContent).toBe("New Header");
        expect(document.querySelector("#new-content")?.textContent).toBe("New Content");
        expect(document.querySelector("#new-footer")?.textContent).toBe("New Footer");
    });
...
describe("CuboMX.swap - Edge cases and errors", () => {
    ...
    it("should handle target not found gracefully", () => {
        ...
        expect(consoleSpy).toHaveBeenCalledWith('[CuboMX] no elements found in current DOM with css selector "#does-not-exist"');
    ...
    it("should handle source not found gracefully", () => {
        ...
        expect(consoleSpy).toHaveBeenCalledWith('[CuboMX] Source element "#non-existent" not found in received HTML');
...
describe("CuboMX.swap - Complex HTML structures", () => {
    ...
    it("should preserve sibling elements", () => {
        ...
        expect(document.querySelector("#keep-me")?.textContent).toBe("Keep this");
        expect(document.querySelector("#keep-me-too")?.textContent).toBe("Keep this too");
        expect(document.querySelector("#new-content")?.textContent).toBe("New content");
