...
describe("CuboMX - Reactivity", () => {
    ...
    it("should trigger global reactivity for other directives when an mx-bind property changes", () => {
        CuboMX.component("myComp", { data: null });
        document.body.innerHTML = `
            <div mx-data="my-comp">
                <div mx-bind="$myComp.data" is-active="true"></div>
        ...
        // Change state via mx-bind object
